...
GAdata = pd.read_csv("GAdata.csv", header=None)
PSOdata = pd.read_csv("PSOdata.csv", header=None)
MPAdata = pd.read_csv("MPAdata.csv", header=None)
IMPAdata = pd.read_csv("HMPAdata.csv", header=None)
