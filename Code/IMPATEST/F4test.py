...
DEdata = pd.read_csv("F4DEdata.csv", header=None)  # 读取csv数据
GAdata = pd.read_csv("F4GAdata.csv", header=None)
PSOdata = pd.read_csv("F4PSOdata.csv", header=None)
MPAdata = pd.read_csv("F4MPAdata.csv", header=None)
IMPAdata = pd.read_csv("F4HMPAdata.csv", header=None)
