...
DEdata = pd.read_csv("F3PSOdata.csv", header=None)  # 读取csv数据
GAdata = pd.read_csv("F2GAdata.csv", header=None)
PSOdata = pd.read_csv("F2DEdata.csv", header=None)
MPAdata = pd.read_csv("F5MPAdata.csv", header=None)
IMPAdata = pd.read_csv("F5HMPAdata.csv", header=None)
