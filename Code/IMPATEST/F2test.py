...
DEdata = pd.read_csv("DEdata.csv", header=None)  # 读取csv数据
GAdata = pd.read_csv("F2GAdata.csv", header=None)
PSOdata = pd.read_csv("F2PSOdata.csv", header=None)
MPAdata = pd.read_csv("F2MPAdata.csv", header=None)
IMPAdata = pd.read_csv("F2HMPAdata.csv", header=None)
