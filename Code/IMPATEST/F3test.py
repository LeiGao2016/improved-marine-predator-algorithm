...
DEdata = pd.read_csv("F3DEdata.csv", header=None)  # 读取csv数据
GAdata = pd.read_csv("F3GAdata.csv", header=None)
PSOdata = pd.read_csv("F3PSOdata.csv", header=None)
MPAdata = pd.read_csv("F3MPAdata.csv", header=None)
IMPAdata = pd.read_csv("F3HMPAdata.csv", header=None)
